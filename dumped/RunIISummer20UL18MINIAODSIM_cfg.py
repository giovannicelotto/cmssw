...
# with command line options: --python_filename RunIISummer20UL18MINIAODSIM_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --filein file:RunIISummer20UL18RECO.root --fileout file:mini.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --era Run2_2018 --runUnscheduled --no_exec --nThreads 1 --mc -n 1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:RunIISummer20UL18RECO.root'),
